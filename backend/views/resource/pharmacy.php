                    ...
                    [
                        ...
                        'buttons' => [
                            'update'=> function ($url, $model, $key) {
                                return Html::a('<span class="glyphicon glyphicon-pencil" ></span>','update_pha?id='.$model->id);
                            },
                            'view'=> function ($url, $model, $key) {
                                $ppt_imgurl = json_encode(unserialize($model->ppt_imgurl));
                                $aHtml = '<span class="glyphicon glyphicon-eye-open" data-toggle="modal" data-target="#formModal" data-content=' . $model->title . ' data-imgurl=' . $ppt_imgurl . ' ></span>';
                                return Html::a($aHtml);
                            },
                        ]
                    ],
